...
/**
 * This is the model class for table "curr_requisite".
 *
 * The followings are the available columns in table 'curr_requisite':
 * @property integer $id
 ...
 * @property CurrRequisite $requisite
 * @property CurrRequisite[] $currRequisites
 */
class CurrRequisite extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CurrRequisite the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'requisite' => array(self::BELONGS_TO, 'CurrRequisite', 'requisite_id'),
			'currRequisites' => array(self::HAS_MANY, 'CurrRequisite', 'requisite_id'),
		);
	}
