...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'catalog-AddRemoveTrackMajor-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'isProspective'); ?>
		<?php echo $form->textField($model,'isProspective'); ?>
		<?php echo $form->error($model,'isProspective'); ?>
	</div>
