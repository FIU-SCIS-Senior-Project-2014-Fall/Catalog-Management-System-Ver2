...
/**
 * This is the model class for table "his_minor".
 *
 * The followings are the available columns in table 'his_minor':
 * @property integer $id
 ...
 */
class HisMinor extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return HisMinor the static model class
	 */
